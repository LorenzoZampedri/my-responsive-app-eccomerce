...
export default function Cart() {
  ...
  const handleCheckout = () => {
    const currentOrders = JSON.parse(localStorage.getItem("my-orders")) || [];
    const newOrder = {
      id: Date.now(),
    ...
    localStorage.setItem("my-orders", JSON.stringify([...currentOrders, newOrder]));

    clearCart(); // Asegurate de tener esta función en tu contexto
    navigate("/my-orders");
  };
